...
if screen.count() == 2 then
    theme.wallpaper_cmd = { "feh --no-fehbg --no-xinerama --bg-fill " .. awful.util.getdir("config") .. "/FloatingIsland_Widescreen16.10_Dual.jpg" }
else
    theme.wallpaper_cmd = { "feh --no-fehbg --bg-fill " .. awful.util.getdir("config") .. "/FloatingIsland_Widescreen16.10.jpg" }
end
-- }}}
